...
import { useLocation } from 'react-router-dom'; // <--- 1. JANGAN LUPA IMPORT INI
...
const Bottombar: React.FC = () => {
  //LOGIKA PENGECEKAN URL DI SINI
  const location = useLocation();
  const hideOnPages = ['/signin', '/signup']; // Daftar halaman tanpa footer

  // Jika URL saat ini ada di daftar, komponen ini tidak akan merender apa-apa (hilang)
  ...
  return (
    <footer className="w-full">
      ...
      {/* Bagian Konten Utama (Hitam) */}
      <div className="bg-[#010006] px-12 pb-12 pt-4 text-white">
